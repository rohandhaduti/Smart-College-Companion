...
urlpatterns = [
    ...
    path('show_student_admin',views.show_student_admin,name='show_student_admin'),
    ...
    path('show_timetable_student',views.show_timetable_student,name='show_timetable_student'),
    ...
    path('show_feedback_admin',views.show_feedback_admin,name='show_feedback_admin'),
    ...
    path('show_department_admin',views.show_department_admin,name='show_department_admin'),
    path('get-assignments/', views.get_assignments),
    path('get-semesters/', views.get_semesters),
